...
#The LoRA addapters, eg q_proj and v_proj
lora_config = LoraConfig(
    r=16,   # Compression rank: balances parameter efficiency and performance
    lora_alpha=32,
    target_modules=["q_proj", "v_proj"],
    lora_dropout=0.15, #Prevents overfitting 
    bias="none",
    task_type="CAUSAL_LM"
)
